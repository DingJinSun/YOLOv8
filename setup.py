...
# NOTE: pkg_resources was removed from modern setuptools; parse requirements.txt directly.
REQUIREMENTS = [
    line.split('#')[0].strip()
    for line in (PARENT / 'requirements.txt').read_text(encoding="utf-8").splitlines()
